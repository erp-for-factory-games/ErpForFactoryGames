...
namespace Erp.Infrastructure.Persistence.Migrations.Postgres
{
    ...
    [Migration("20260524081420_AddPlayerReIngestFlag")]
    partial class AddPlayerReIngestFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Domain.Common.AgentToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Erp.Domain.Common.Player", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Erp.Domain.Common.PlayerCatalogue", b =>
                {
                    b.Property<Guid>("PlayerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Erp.Domain.Common.AgentToken", b =>
                {
                    b.HasOne("Erp.Domain.Common.Player", null)
                        .WithMany()
